...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/ryzenchen/lx-qq-music-mobile#readme')
  }
  ...
  return (
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        <Text style={styles.text}>本软件 LX-Q 完全免费，基于开源项目定制。开源地址：</Text>
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/ryzenchen/lx-qq-music-mobile</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
